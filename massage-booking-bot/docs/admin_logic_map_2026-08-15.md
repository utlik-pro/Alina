...
83 чата. **33 живых диалога вычитаны построчно**; остальные 50 —
классифицированы и верифицированы выборочно: 25 broadcast-рассылок
(открыты 3 шт., текст идентичен), 12 welcome-only без ответа клиента
(открыты 3 шт., пусто), 8 первых контактов с шаблонным превью, 2 моих
тестовых. Ограничение: переписка живых админов в WhatsApp
(971551933662) не видна — только IG-часть воронки.
...
## Находки полной вычитки (33 диалога, 15.08)

- **Состав комбо-275 по минутам** (Anum ishtiaq): «Lymphatic body massage
  30 / Cupping 15 / Head massage 15» = **60 мин, не 45** как в креативе.
  prices.py исправлен.
- **Пакеты называют в 4 чатах**: 5×body 1550 (hk.xx7, محمد احمد, um mahra),
  5×face 1650 (Hendaq). um mahra дословно: «Body+cupping 275 / Lymphatic
  350 / 5 session 1550 lymph massage».
- **Номер, который админы дают клиенту** (Sina Sina): «97155 193 3662» —
  совпадает с нашим WHATSAPP_CTA_NUMBER 971551933662. Воронка сходится.
- **Арабский вход → английский ответ** (Zoubida «مرحبا / ممكن احجز جلسة»,
  نورة): админы НЕ переключаются на арабский, и клиент спокойно
  продолжает по-английски и даёт номер. Подтверждает нашу языковую
  политику (English by default).
- **Клиенты охотно дают номера в IG**: 8 номеров за 4 дня (0588644106,
  0543897920, 0556410108, 0563339669, 0505333265, 0504711328,
  +971508417285, 0506624767) — сбор контакта в Direct работает.
- **Цикл дожима вживую** (Fatima Tami, 15.08): 10:37 шаблон → 13:12
  «Should we book for you?» (+2,5 ч) → клиент «What time» → 14:03
  «What time is preferable for you? We will find convenient time».
- **Мягкое отпускание** (Aanshika Arya): «I will inform… If interested» —
  без давления, но и без follow-up-даты.
- **Тупик «мы напишем вам в WhatsApp» БЕЗ запроса номера** — 3 случая
  (sireenoo, Siobhán Forde, Gayatri): обещание, которое админ физически
  не может выполнить. Самая дорогая системная ошибка.

## Системные слабости админов (подтверждены на 33 диалогах)
