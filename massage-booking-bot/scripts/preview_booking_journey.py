...
async def main():
    ...
    result={'calendar':'fake; only tomorrow 14:00/16:00', 'turns':[]}
    with tempfile.TemporaryDirectory(prefix='crystal-journey-') as tmp, pytest.MonkeyPatch.context() as patch:
        ...
        try:
            for text in turns:
                ...
                Path('../docs/full-booking-journey-2026-09-06.json').write_text(json.dumps(result,ensure_ascii=False,indent=2,default=str))
